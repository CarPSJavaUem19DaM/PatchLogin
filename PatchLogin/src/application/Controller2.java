...
public class Controller2 {
    ...
    @FXML
    private AnchorPane opacityPane,drawerPane; //Ponemos esos id's en la vista

    @FXML
    private Pane pane1,pane2,pane3,pane4;

    @FXML
    private ImageView drawerImage;//Ponemos ese id al imageView del scenebuilder
    ...
    public void initialize() {
        ...
        /*pane1.setStyle("-fx-background-image: url('sample/1.jpg')"); Y estan asociadas en CSS
